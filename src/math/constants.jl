...
function PI(::Type{ArbFloat{P}}) where {P}
    ...
    ccall(@libarb(arb_const_pi), Void, (Ptr{ArbFloat}, Int), Ref{z}, P)
    return z
end
...
function SQRTPI(::Type{ArbFloat{P}}) where {P}
    z = initializer(ArbFloat{P})
    ccall(@libarb(arb_const_sqrt_pi), Void, (Ptr{ArbFloat}, Int), Ref{z}, P)
    return z
end
...
function LOG2(::Type{ArbFloat{P}}) where {P}
    z = initializer(ArbFloat{P})
    ccall(@libarb(arb_const_log2), Void, (Ptr{ArbFloat}, Int), Ref{z}, P)
    return z
end
...
function LOG10(::Type{ArbFloat{P}}) where {P}
    z = initializer(ArbFloat{P})
    ccall(@libarb(arb_const_log10), Void, (Ptr{ArbFloat}, Int), Ref{z}, P)
    return z
end
...
function EXP1(::Type{ArbFloat{P}}) where {P}
    z = initializer(ArbFloat{P})
    ccall(@libarb(arb_const_e), Void, (Ptr{ArbFloat}, Int), Ref{z}, P)
    return z
end
...
function EULER(::Type{ArbFloat{P}}) where {P}
    z = initializer(ArbFloat{P})
    ccall(@libarb(arb_const_euler), Void, (Ptr{ArbFloat}, Int), Ref{z}, P)
    return z
end
...
function CATALAN(::Type{ArbFloat{P}}) where {P}
    z = initializer(ArbFloat{P})
    ccall(@libarb(arb_const_catalan), Void, (Ptr{ArbFloat}, Int), Ref{z}, P)
    return z
end
...
function KINCHIN(::Type{ArbFloat{P}}) where {P}
    z = initializer(ArbFloat{P})
    ccall(@libarb(arb_const_kinchin), Void, (Ptr{ArbFloat}, Int), Ref{z}, P)
    return z
end
...
function GLAISHER(::Type{ArbFloat{P}}) where {P}
    z = initializer(ArbFloat{P})
    ccall(@libarb(arb_const_apery), Void, (Ptr{ArbFloat}, Int), Ref{z}, P)
    return z
end
