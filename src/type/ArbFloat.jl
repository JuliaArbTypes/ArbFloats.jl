...
@inline finalize{T<:ArbFloat}(::Type{T}) = ccall(@libarb(arb_clear), Void, (Ptr{ArbFloat{P}},), &x)
@inline initial0{T<:ArbFloat}(::Type{T}) = ccall(@libarb(arb_init), Void, (Ptr{ArbFloat{P}},), &x)
