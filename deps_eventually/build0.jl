...
if !ispath(Pkg.dir("ArbFloats", "deps", "usr"))
    mkdir(Pkg.dir("ArbFloats", "deps", "usr"))
end
if !ispath(Pkg.dir("ArbFloats", "deps", "usr", "bin"))
    mkdir(Pkg.dir("ArbFloats", "deps", "usr", "bin"))
end
...
vdir = Pkg.dir("ArbFloats", "deps", "usr")
...
if !ispath(Pkg.dir("ArbFloats", "local", "mpir-2.7.2"))
...
if !ispath(Pkg.dir("ArbFloats", "local", "mpfr-3.1.4"))
