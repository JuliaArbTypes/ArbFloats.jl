...
export ArbFloat,      # co-matched decimal rounding, n | round(hi,n,10) == round(lo,n,10)
       ...
       interval_stringSmall, interval_stringCompact, interval_string, 
       interval_stringLarge, interval_stringAll, 
       showsmall, showcompact, showlarge, showallcompact, showpretty,
       showsmall_interval, showcompact_interval, show_interval, 
       showlarge_interval, showall_interval,
