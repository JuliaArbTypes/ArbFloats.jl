...
function zero(::Type{MagFloat})
    ...
    ccall(@libarb(mag_set_ui), Void, (Ptr{MagFloat}, UInt64), Ref{z}, 0x0000000000000000)
    return z
end
...
function one(::Type{MagFloat})
    z = MagFloat(0, 0x0000000000000000)
    ccall(@libarb(mag_set_ui), Void, (Ptr{MagFloat}, UInt64), Ref{z},  0x0000000000000001)
    return z
end
...
for (T,M) in ((:UInt, :ui), (:Int, :si), (:Float64, :d))
  @eval begin
    function convert(::Type{MagFloat}, x::($T))
        z = MagFloat()
        ccall( :($(QuoteNode(Symbol("mag_set_", $M))), "libarb"), Void, (Ptr{$T}, ), Ref{z} )
...
function convert(::Type{MagFloat}, x::Float64)
    ...
    z = MagFloat()
    ccall(@libarb(mag_set_d), Void, (Ptr{MagFloat}, Ptr{Float64}), Ref{z}, Ref{x})
    return z
end
...
if Int == Int64
  function upperbound(::Type{MagFloat}, x::UInt64)
    z = MagFloat()
    ccall(@libarb(mag_set_ui), Void, (Ptr{MagFloat}, Ptr{UInt64}), Ref{z}, Ref{x})
    return z
  end
  function lowerbound(::Type{MagFloat}, x::UInt64)
    z = MagFloat()
    ccall(@libarb(mag_set_ui_lower), Void, (Ptr{MagFloat}, Ptr{UInt64}), Ref{z}, Ref{x})
    return z
  end
  ...
  function upperbound(::Type{MagFloat}, x::UInt32)
    z = MagFloat()
    ccall(@libarb(mag_set_ui), Void, (Ptr{MagFloat}, Ptr{UInt32}), Ref{z}, Ref{x})
    return z
  end
  function lowerbound(::Type{MagFloat}, x::UInt32)
    z = MagFloat()
    ccall(@libarb(mag_set_ui_lower), Void, (Ptr{MagFloat}, Ptr{UInt32}), Ref{z}, Ref{x})
    return z
  end
...
function convert(::Type{Float64}, x::MagFloat)
    z = ccall(@libarb(mag_get_d), Float64, (Ptr{MagFloat}, ), Ref{x})
    return z
end
